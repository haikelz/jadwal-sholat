...
export const env = createEnv({
  client: {
    NEXT_PUBLIC_QURAN_API: z.url().min(1),
    NEXT_PUBLIC_PUASA_SUNNAH_API: z.url().min(1),
    NEXT_PUBLIC_JADWAL_SHOLAT_API: z.url().min(1),
    NEXT_PUBLIC_ASMAUL_HUSNA_API: z.url().min(1),
    NEXT_PUBLIC_DOA_HARIAN_API: z.url().min(1),
    NEXT_PUBLIC_NOMINATIM_API: z.url().min(1),
    NEXT_PUBLIC_HADITH_API: z.url().min(1),
  },
  experimental__runtimeEnv: {
    ...
    NEXT_PUBLIC_HADITH_API: process.env.NEXT_PUBLIC_HADITH_API,
  },
});
