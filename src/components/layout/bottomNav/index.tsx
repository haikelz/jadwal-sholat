...
import { MdBook, MdDarkMode, MdHomeFilled, MdLightMode, MdOutlineAccessTime } from "react-icons/md";
...
const BottomNav = () => {
  ...
  return (
    <div className="fixed pt-3 py-1 gap-4 bg-teal-600 text-white w-full bottom-0 grid grid-cols-4 grid-rows-1">
      ...
      <button className="flex cursor-pointer flex-col px-4 justify-center items-center" onClick={changeTheme}>
      {theme === "dark" ? 
        <MdDarkMode size="20px" /> : <MdLightMode size="20px" />}
