    ...
    <div className="grid xl:grid-cols-5 lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 text-center gap-5 grid-rows-1">
      {kota.map((loc, index: number) => (
        <Link
          ...
          key={index + 1}
        >
          <div className="cursor-pointer hover:bg-teal-500 hover:shadow-cards border-2 dark:bg-[#1F1F28] dark:hover:shadow-dark dark:border-white border-black duration-200 transition-all overflow-hidden bg-teal-400 py-6 px-10 flex justify-center items-center">
